...
const Bio = () => {
  ...
  //   about: 'Highly motivated Web Developer with a big passion for internet and all related.. Skilled in Microsoft Office, Graphic Design, Programming (JavaScript, MongoDB)'
  // });
